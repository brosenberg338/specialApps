...
router.post('/', function (req, res, next) {
  ...
  let allergy3 = req.body.allergy3 || '';
    ...
    &&  NOT ingredient4 = ${allergy3}`, function (error, results, fields)   { 
     /* connection.query(SQL` SELECT *  FROM recipe WHERE NOT ingredient1 = ${allergy1} || ${allergy2} || ${allergy3} && NOT ingredient2 = ${allergy1} || ${allergy2} || ${allergy3} && NOT ingredient3 = ${allergy1} || ${allergy2} || ${allergy3} && NOT ingredient4 = ${allergy1} || ${allergy2} || ${allergy3}`, function (error, results, fields)   {       */
    
     /* connection.query(SQL`SELECT *  FROM recipe WHERE NOT ingredient1 = ${allergy2}  ||   ${allergy1}  && NOT ingredient4 = ${allergy2}  && NOT  ingredient3 = ${allergy1}  `) , function (error, results, fields)   { */
